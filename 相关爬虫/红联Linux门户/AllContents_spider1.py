...
def next_page():
    for i in range(1,500):  # 有一个翻页小技巧
        time.sleep(1)
        driver.find_element_by_xpath('/html/body/div[2]/div[1]/div[3]/ul/li[last()]/a').click()
        html = driver.page_source
        return html
...
def parse_page(html):
    ...
    type = selector.xpath('/html/body/div[2]/div[1]/div[1]/a[3]/text()')
...
if __name__ == "__main__":
    # for url in alllist:
    url ='http://www.linuxdiyf.com/linux/kf/'
